...
public class activity_healthy_parametre extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    for (int i = 0; i < userList.size(); i++) {
                        if (userList.get(i).name.equals(userObj.name) == true) {
                            ...
                            Toast.makeText(activity_healthy_parametre.this, str, Toast.LENGTH_LONG).show();
                            break;
                        }
                    }
                }
                ...
                Toast.makeText(activity_healthy_parametre.this,exception.toString(),Toast.LENGTH_LONG).show();
